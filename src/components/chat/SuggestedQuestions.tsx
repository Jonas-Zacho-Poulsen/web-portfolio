        ...
        {suggestedQuestions.map((item, index) => (
          ...
          >
            <div className="flex items-center space-x-2"> {/* Reduced spacing */}
              ...
              <span className="text-xs text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200"> {/* Smaller text */}
                {item.question}
              </span>
            </div>
          </motion.button>
